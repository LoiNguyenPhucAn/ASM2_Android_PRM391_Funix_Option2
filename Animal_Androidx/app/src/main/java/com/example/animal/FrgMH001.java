...
public class FrgMH001 extends Fragment implements View.OnClickListener{
    ...
    IconLayoutBinding iconLayoutBinding;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.itemSea_card:
                iconLayoutBinding.icon.setTag("Sea");
                break;

            case R.id.itemMammal_card:
                iconLayoutBinding.icon.setTag("mammal");
                break;

            case R.id.itemBird_card:
                iconLayoutBinding.icon.setTag("bird");
                break;
